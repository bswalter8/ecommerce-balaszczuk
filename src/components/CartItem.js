...
const handleCantidad = (cantidad) =>{
  ...
  return (
    <Item_css>      
                ...
                <button className="elimiar" onClick={handleClick}> Eliminar del Carrito</button> 
                <ItemCount stock={libro.cantidad + 4} initial={libro.cantidad}   onAdd={handleCantidad} textoBoton="Modificar cantidad"/>
    </Item_css>  
  )
}
